...
exports.ErrorsApp = void 0;
exports.ErrorsApp = {
    ERROR_FORBIDDEN: 'Доступ до цієї функції Вам забороно',
    EMPTY_NAME: 'Поле ім`я повинне бути заповнене!',
    NOT_VALID_EMAIL: 'Ви ввели не валідний формат email адреси. Ввведіть email адресу в форматі user@example.com!',
    NOT_VALID_PHONE: 'Введіть будь ласка Ваш номер телефону у форматі +380XXXXXXXXX!',
    NOT_VALID_PASSWORD: 'Пароль має містити принаймні 6 символів та в його складі має бути принаймні одна літера та один спеціальний символ (*, #, & тощо)!',
    ...
    FORBIDDEN_PRICE_UPDATE: 'У вас немає прав для редагування цієї позиції прайсу!',
